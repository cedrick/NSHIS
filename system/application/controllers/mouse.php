...
class Mouse extends Controller {
	...
	function add()
	{
		...
		else 
		{
			...
			if($id)
			{
				$this->Stats_model->insert_log($this->session->userdata('user_id'), $id, 'mouse', 'add');
	...
	function assign($location)
	{
		...
		else 
		{
			...
			if ($id)
			{
				$this->Stats_model->insert_log($this->session->userdata('user_id'), $mouse_id, 'mouse', 'assign', $id);
	...
	function view($mouse_id)
	{
		...
		$logs = $this->Globals_model->get_item_logs($mouse_id, 'mouse');
	...
	function edit($mouse_id = NULL)
	{
		if (isset($mouse_id))
		{
			...
			else 
			{
				...
				if ($id)
				{
					$this->Stats_model->insert_log($this->session->userdata('user_id'), $id, 'mouse', 'edit');
	...
	function delete($mouse_id)
	{
		...
		else 
		{
			...
			else 
			{
				...
				if ($id)
				{
					$this->Stats_model->insert_log($this->session->userdata('user_id'), $id, 'mouse', 'delete');
	...
	function transfer($mouse_id = NULL)
	{
		if (isset($mouse_id))
		{
			...
			else
			{
				...
				if ($id)
				{
					$this->Stats_model->insert_log($this->session->userdata('user_id'), $mouse_id, 'mouse', 'transfer', $id);
	...
	function swap($mouse_id = NULL)
	{
		if (isset($mouse_id))
		{
			...
			else
			{
				...
				if ($id)
				{
					$this->Stats_model->insert_log($this->session->userdata('user_id'), $mouse_id, 'mouse', 'swap', $id);
	...
	function comment($mouse_id)
	{
		...
		else 
		{
			...
			if ($id)
			{
				$this->Stats_model->insert_log($this->session->userdata('user_id'), $id, 'mouse', 'comment');
	...
	function pullout($mouse_id)
	{
		...
		if ($return) 
		{
			$this->Stats_model->insert_log($this->session->userdata('user_id'), $mouse_id, 'mouse', 'pullout', $return);
