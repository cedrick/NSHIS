...
class Dialpad extends Controller {
	...
	function add()
	{
		...
		else 
		{
			...
			if($id)
			{
				$this->Stats_model->insert_log($this->session->userdata('user_id'), $id, 'dialpad', 'add');
	...
	function assign($location)
	{
		...
		else 
		{
			...
			if ($id)
			{
				$this->Stats_model->insert_log($this->session->userdata('user_id'), $dialpad_id, 'dialpad', 'assign', $id);
	...
	function view($dialpad_id)
	{
		...
		$logs = $this->Globals_model->get_item_logs($dialpad_id, 'dialpad');
	...
	function edit($dialpad_id = NULL)
	{
		if (isset($dialpad_id))
		{
			...
			else 
			{
				...
				if ($id)
				{
					$this->Stats_model->insert_log($this->session->userdata('user_id'), $id, 'dialpad', 'edit');
	...
	function delete($dialpad_id)
	{
		...
		else 
		{
			...
			else 
			{
				...
				if ($id)
				{
					$this->Stats_model->insert_log($this->session->userdata('user_id'), $id, 'dialpad', 'delete');
	...
	function transfer($dialpad_id = NULL)
	{
		if (isset($dialpad_id))
		{
			...
			else
			{
				...
				if ($id)
				{
					$this->Stats_model->insert_log($this->session->userdata('user_id'), $dialpad_id, 'dialpad', 'transfer', $id);
	...
	function swap($dialpad_id = NULL)
	{
		if (isset($dialpad_id))
		{
			...
			else
			{
				...
				if ($id)
				{
					$this->Stats_model->insert_log($this->session->userdata('user_id'), $dialpad_id, 'dialpad', 'swap', $id);
	...
	function comment($dialpad_id)
	{
		...
		else 
		{
			...
			if ($id)
			{
				$this->Stats_model->insert_log($this->session->userdata('user_id'), $id, 'dialpad', 'comment');
	...
	function pullout($dialpad_id)
	{
		...
		if ($return) 
		{
			$this->Stats_model->insert_log($this->session->userdata('user_id'), $dialpad_id, 'dialpad', 'pullout', $return);
