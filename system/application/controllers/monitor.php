...
class Monitor extends Controller {
	...
	function add()
	{
		...
		else 
		{
			...
			if($id)
			{
				$this->Stats_model->insert_log($this->session->userdata('user_id'), $id, 'monitor', 'add');
	...
	function assign($location)
	{
		...
		else 
		{
			...
			if ($id)
			{
				$this->Stats_model->insert_log($this->session->userdata('user_id'), $monitor_id, 'monitor', 'assign', $id);
	...
	function view($monitor_id)
	{
		...
		$logs = $this->Globals_model->get_item_logs($monitor_id, 'monitor');
	...
	function edit($monitor_id = NULL)
	{
		if (isset($monitor_id))
		{
			...
			else 
			{
				...
				if ($id)
				{
					$this->Stats_model->insert_log($this->session->userdata('user_id'), $id, 'monitor', 'edit');
	...
	function delete($monitor_id)
	{
		...
		else 
		{
			...
			else 
			{
				...
				if ($id)
				{
					$this->Stats_model->insert_log($this->session->userdata('user_id'), $id, 'monitor', 'delete');
	...
	function transfer($monitor_id = NULL)
	{
		if (isset($monitor_id))
		{
			...
			else
			{
				...
				if ($id)
				{
					$this->Stats_model->insert_log($this->session->userdata('user_id'), $monitor_id, 'monitor', 'transfer', $id);
	...
	function swap($monitor_id = NULL)
	{
		if (isset($monitor_id))
		{
			...
			else
			{
				...
				if ($id)
				{
					$this->Stats_model->insert_log($this->session->userdata('user_id'), $monitor_id, 'monitor', 'swap', $id);
	...
	function comment($monitor_id)
	{
		...
		else 
		{
			...
			if ($id)
			{
				$this->Stats_model->insert_log($this->session->userdata('user_id'), $id, 'monitor', 'comment');
	...
	function pullout($monitor_id)
	{
		...
		if ($return) 
		{
			$this->Stats_model->insert_log($this->session->userdata('user_id'), $monitor_id, 'monitor', 'pullout', $return);
