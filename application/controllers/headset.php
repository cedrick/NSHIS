...
class Headset extends CI_Controller {
	...
	function add()
	{
		...
		else 
		{
			...
			if($id)
			{
				$this->Stats_model->insert_log($this->session->userdata('user_id'), $id, 'headset', 'add');
	...
	function assign($location)
	{
		...
		else 
		{
			...
			if ($id)
			{
				$this->Stats_model->insert_log($this->session->userdata('user_id'), $headset_id, 'headset', 'assign', $id);
	...
	function view($headset_id)
	{
		...
		$logs = $this->Globals_model->get_item_logs($headset_id, 'headset');
	...
	function edit($headset_id = NULL)
	{
		if (isset($headset_id))
		{
			...
			else 
			{
				...
				if ($id)
				{
					$this->Stats_model->insert_log($this->session->userdata('user_id'), $id, 'headset', 'edit');
	...
	function delete($headset_id)
	{
		...
		else 
		{
			...
			else 
			{
				...
				if ($id)
				{
					$this->Stats_model->insert_log($this->session->userdata('user_id'), $id, 'headset', 'delete');
	...
	function transfer($headset_id = NULL)
	{
		if (isset($headset_id))
		{
			...
			else
			{
				...
				if ($id)
				{
					$this->Stats_model->insert_log($this->session->userdata('user_id'), $headset_id, 'headset', 'transfer', $id);
	...
	function swap($headset_id = NULL)
	{
		if (isset($headset_id))
		{
			...
			else
			{
				...
				if ($id)
				{
					$this->Stats_model->insert_log($this->session->userdata('user_id'), $headset_id, 'headset', 'swap', $id);
	...
	function comment($headset_id)
	{
		...
		else 
		{
			...
			if ($id)
			{
				$this->Stats_model->insert_log($this->session->userdata('user_id'), $id, 'headset', 'comment');
	...
	function pullout($headset_id)
	{
		...
		if ($return) 
		{
			$this->Stats_model->insert_log($this->session->userdata('user_id'), $headset_id, 'headset', 'pullout', $return);
