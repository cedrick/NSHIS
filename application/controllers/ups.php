...
class Ups extends CI_Controller {
	...
	function add()
	{
		...
		else 
		{
			...
			if($id)
			{
				$this->Stats_model->insert_log($this->session->userdata('user_id'), $id, 'ups', 'add');
	...
	function assign($location)
	{
		...
		else 
		{
			...
			if ($id)
			{
				$this->Stats_model->insert_log($this->session->userdata('user_id'), $ups_id, 'ups', 'assign', $id);
	...
	function view($ups_id)
	{
		...
		$logs = $this->Globals_model->get_item_logs($ups_id, 'ups');
	...
	function edit($ups_id = NULL)
	{
		if (isset($ups_id))
		{
			...
			else 
			{
				...
				if ($id)
				{
					$this->Stats_model->insert_log($this->session->userdata('user_id'), $id, 'ups', 'edit');
	...
	function delete($ups_id)
	{
		...
		else 
		{
			...
			else 
			{
				...
				if ($id)
				{
					$this->Stats_model->insert_log($this->session->userdata('user_id'), $id, 'ups', 'delete');
	...
	function transfer($ups_id = NULL)
	{
		if (isset($ups_id))
		{
			...
			else
			{
				...
				if ($id)
				{
					$this->Stats_model->insert_log($this->session->userdata('user_id'), $ups_id, 'ups', 'transfer', $id);
	...
	function swap($ups_id = NULL)
	{
		if (isset($ups_id))
		{
			...
			else
			{
				...
				if ($id)
				{
					$this->Stats_model->insert_log($this->session->userdata('user_id'), $ups_id, 'ups', 'swap', $id);
	...
	function comment($ups_id)
	{
		...
		else 
		{
			...
			if ($id)
			{
				$this->Stats_model->insert_log($this->session->userdata('user_id'), $id, 'ups', 'comment');
	...
	function pullout($ups_id)
	{
		...
		if ($return) 
		{
			$this->Stats_model->insert_log($this->session->userdata('user_id'), $ups_id, 'ups', 'pullout', $return);
