...
class Monitor_model extends CI_Model {
	...
	function swap($monitor_id, $cubicle_monitor_id)
	{
		...
		if ($update1 && $update2 && $update3)
		{
			$this->devicelog->insert_log($this->session->userdata('user_id'), $monitor_id, 'monitor', 'swap', $dest_cubicle, array('swap_device_id' => $dest_monitor, 'swap_cubicle_id' => $source_cubicle));
	...
	{
		$return = $this->db->get_where('nshis_monitors', array('flag_assigned' => 0, 'status' => 1));
