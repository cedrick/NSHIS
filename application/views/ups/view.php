				...
				?>
					<div class="section width500" >
						<div class="sectionHeader">Ups <?php echo $row->ups_name;?> Info</div>
						<div class="sectionBody">
							<table width="100%" border="0" cellpadding="0" id="latestStatusTable" style="whitespace: nowrap;">
								<tr>
									<td id="resultName" width="30%">Ups Name</td><td><?php echo $row->ups_name; ?></td>
								</tr>
								<tr>
				...
				?>
					<div class="section width500" >
						<div class="sectionHeader">Ups Info</div>
						<div class="sectionBody">
							Ups dont exist.
						</div>
					</div>
