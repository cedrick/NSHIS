					<?php 
						...
						echo form_open(base_url() . 'ups/swap/' . $this->uri->segment(3));
						...
						if ($data)
						{
							...
							foreach ($data->result() as $row)
							{
								...
								{
									$ups_to_swap = $row->ups_name;
									continue;
								}
								$array2 = array($row->cubicle_id.'|'.$row->ups_id => $row->cb_name.' - '.$row->ups_name);
					...
					<div class="section width400" >
						<div class="sectionHeader">Swap <?php echo $ups_to_swap; ?></div>
