							...
							<?php 
								if ($data)
								{
									...
									foreach ($data->result() as $row)
									{
										...
										echo "</td><td width=250px>".$row->other_name."</td><td width=250px>".$cubicle_link."</td><td>".anchor('connector/edit/'.$row->connector_id,'edit')." | ".anchor('connector/delete/'.$row->connector_id,'delete')."</td></tr>";
										$ctr ++;
									}
								}
								else 
